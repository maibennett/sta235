...
{{% button href="https://raw.githubusercontent.com/maibennett/website_github/master/exampleSite/content/files/Rmarkdown_template.Rmd" icon="fas fa-download"" icon-position="right" %}}Download template{{% /button %}}