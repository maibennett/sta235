...
.center[
![:scale 70%](https://github.com/maibennett/sta235/raw/main/exampleSite/content/bootcamp/images/rstudio_window_help.png)]
...
.pull-left[
- Most times we need to **.darkorange[transform]** and **.darkorange[structure]** data for analysis.
