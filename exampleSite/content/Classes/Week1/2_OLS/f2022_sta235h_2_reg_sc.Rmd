...
- How do you interpret these results?
  ...
  - Remember to look at the point estimate, but also its variance!
...
- <u>On average</u>, movies that pass the Bechdel test have an adjusted revenue that is $|\hat{\beta}_1|$ millions less than a movie that doesn't pass the Bechdel test. The association is <u>statistically significant at a 1% level</u>
...
- <u>On average</u>, movies that pass the Bechdel test have 11 millions more in adjusted revenue compared to a movie that doesn't pass the Bechdel test, <u>holding other variables constant</u>. The association is statistically significant at the 5% level.
