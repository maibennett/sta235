...
- We have some data and code on the **<u>.darkorange[[course website](https://sta235.netlify.app/classes/week1/)]</u>**

- Dataset from **<u>.darkorange[[fivethirtyeight.com](https://github.com/fivethirtyeight/data/tree/master/bechdel)]</u>**:
...
bechdel %>% select(Year, Adj_Revenue, Adj_Budget, Metascore, imdbRating, bechdel_test) %>%
  sumtable(., out = 'kable') %>% kable_paper()
```
...
- <u>On average</u>, movies that pass the Bechdel test have an adjusted revenue that is $|\hat{\beta}_1|$ millions less than a movie that doesn't pass the Bechdel test.
...
- <u>On average</u>, movies that pass the Bechdel test have 11 millions more in adjusted revenue compared to a movie that doesn't pass the Bechdel test, <u>holding other variables constant</u>.
