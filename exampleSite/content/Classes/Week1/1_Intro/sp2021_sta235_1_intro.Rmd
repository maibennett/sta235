...
- **.darkorange[Required Books]**:
  ...
  - James, G., D. Witten, T. Hastie, & R. Tibshirani. (2017). "An Introduction to Statistical Learning with Applications in R". Springer. (*Available online*)
]
.pull-right-little_l[
