...
- **.darkorange[Differences in Differences]**:
  ...
  - How to combine it with natural experiments.
...
.box-5t[You, as a researcher, did not assigned units to treatment levels]
--

1) **.darkorange[Random]**: Assignment to an intervention is random (e.g. lottery).
2) **.darkorange[As if random]**: Assignment to an intervention is not random, but it's not correlated with potential confounders.
...
.pull-right[
.center[
![](https://raw.githubusercontent.com/maibennett/sta235/main/exampleSite/content/Classes/Week6/1_Natural_Experiments/images/map1_edited.png))
]
]
