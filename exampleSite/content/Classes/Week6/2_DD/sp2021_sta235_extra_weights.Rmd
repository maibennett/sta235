---
title: "STA 235 - Looking at weigths in pictures"
...
.center[
![:scale 80%](https://raw.githubusercontent.com/maibennett/sta235/main/exampleSite/content/Classes/Week6/2_DD/images/pokemon1.png)]

---
.center[
![](https://raw.githubusercontent.com/maibennett/sta235/main/exampleSite/content/Classes/Week6/2_DD/images/pokemon2.png)]
---
.center[
![](https://raw.githubusercontent.com/maibennett/sta235/main/exampleSite/content/Classes/Week6/2_DD/images/pokemon3.png)]
...
plot_late <- ggplot(gb_trends, aes(x = month, y = income, color = type)) +
  ...
  scale_y_continuous(labels = dollar) +
  labs(x = "Month", y = NULL,
       subtitle = "Negative effect for later group!") +
  theme_bw(base_size = 21, base_family = "Fira Sans Condensed") +
  theme(panel.grid.major.x = element_blank())+
          theme_ipsum_fsc(plot_title_face = "bold",plot_title_size = 24) +
