---
title: "STA 235H - Multiple Regression: Binary Outcomes and Heteroskedasticity"
subtitle: "Fall 2022"
...
- **.darkorange[Group assignment]** for the final project is on Canvas (People > Final Project)

  - Most groups were kept the same; some had one or two people added.
  - Remember that the first submission is on **.darkorange[October 9th]**.
  - Drop by office hours if you have questions!
  
--

- You submitted **.darkorange[Homework 1]** last Friday
  
  - Answer key (with rubric) will be posted this week.
  
--

.box-4Trans[Homework 2 will be posted this Friday]

---
# Last week

.pull-left[
- (Almost) finished our chapter on **.darkorange[multiple regression]**.
  
  - **.darkorange[Statistical Adjustment]**: Unveiling useful associations, interaction terms, non-linearity. 

- Pushed **.darkorange[multicollinearity]**: Uploaded a short video and we'll talk more about it when we ran into the issue.
]
...
.pull-left[
**.darkorange[Knowledge check]**:

- Why do we incorporate polynomial terms to a regression?

- How do we estimate the association between Y and X in a quadratic model?
$$Income = \beta_0 + \beta_1Height + \beta_2 Height^2 + \varepsilon$$
]
...
- What's the deal with **.darkorange[binary outcomes]**?
