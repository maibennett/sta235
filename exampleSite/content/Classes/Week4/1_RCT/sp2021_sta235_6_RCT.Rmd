...
<br>
<br>
.bottom[.lightgrey[h/t to @paul_gp]]
...
- **.darkorange[Statistical power]** refers to the probability that a test correctly rejects the null hypothesis $H_0$.
...
- **.darkorange[Type I error]**: Probability of rejecting the null hypothesis, when the null is true.

- **.darkorange[Type I error]**: Probability of not rejecting the null hypothesis, when the null is false.

---
# Statistical power

.pull-left[
![:scale 50%](https://github.com/maibennett/sta235/raw/main/exampleSite/content/Classes/Week4/1_RCT/images/type_1_errors.png)
]

.pull-right[
![:scale 50%](https://github.com/maibennett/sta235/raw/main/exampleSite/content/Classes/Week4/1_RCT/images/type_2_errors.png)
]
...
---
# What affects power calculations?

- There are many parameters we need to consider for statistical power.
...
- If she was just guessing, she has **.darkorange[20 possibilities]** (because $6 \choose 3 = 20$).
