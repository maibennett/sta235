...
.box-3t[$\frac{1}{N_T}\sum_{i\in T}Y_i - \frac{1}{N_C}\sum_{i\in C}Y_i$]

.box-5t[$$Y_i = \beta_0 + \beta_1 Z_i + \varepsilon_i$$]

--

**.darkorange[How do we incorporate stratification here?]**
...
- Imagine you want to test the effect of providing information about employment and expected income to students on their choice of university and/or major.
...
- **.darorange[Statistical power]** refers to the magnitude of the effects I am able to detect given my data.
...
.pull-right[
.box-5b[Enroll 200 participants]
...
.center[
![]((https://github.com/maibennett/sta235/raw/main/exampleSite/content/Classes/Week4/1_RCT/images/power-search.png)
]
