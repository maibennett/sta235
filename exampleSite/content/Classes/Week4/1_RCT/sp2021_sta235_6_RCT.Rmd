...
.box-2LA[Homework 2 will be posted today (due March 3rd)]
...
.center[
![](https://github.com/maibennett/sta235/raw/main/exampleSite/content/Classes/Week4/1_RCT/images/type_1_errors.png)]
]
...
.center[
![](https://github.com/maibennett/sta235/raw/main/exampleSite/content/Classes/Week4/1_RCT/images/type_2_errors.png)]
]
...
```{r power_calc, echo = FALSE, warning=FALSE, fig.width=6, fig.height=4.5, out.width="100%"}
...
$$Pr(k successes) = \frac{1}{total combinations}{n \choose k} {n \choose (n-k)}$$
--

![:scale 100%](https://github.com/maibennett/sta235/raw/main/exampleSite/content/Classes/Week4/1_RCT/images/combinations.png)]
