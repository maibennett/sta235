...
.pull-right[
- $\text{Pr[U | Leave 1]} = 0.15$

- $\text{Pr[U | Leave 2]} = 0.53$
]
...
.center[
![](https://raw.githubusercontent.com/maibennett/sta235/main/exampleSite/content/Classes/Week12/1_DecisionTrees/images/DT_mandalorian4.png)]


---
# Let's start from our previous tree
