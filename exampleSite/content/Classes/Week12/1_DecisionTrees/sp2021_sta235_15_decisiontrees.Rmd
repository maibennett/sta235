...
&\text{Pr[Correct | city = 0]} \times  \text{Pr[city = 0]} = \\
...
.pull-right[
If we split on `City`:
- $\text{Pr(unsubs|city=1)} = \frac{152}{4288}$
]
...
- $\text{Pr(unsubs|city=0)} = \frac{22}{712}$
]
...
- $\text{Pr(unsubs|city=1)} = \frac{152}{4288} = p_1$

- $\text{Pr(unsubs|city=0)} = \frac{22}{712} = p_2$

$$\text{Pr(unsubs)} = \text{Pr(city=1)}\cdot p_1 + \text{Pr(city=0)}\cdot p_2$$
]
...
$$\text{Pr(unsubs)} = \text{Pr(city=1)}\cdot p_1 + \text{Pr(city=0)}\cdot p_2$$
$$ = \frac{4288}{5000}\cdot p_1 + \frac{712}{5000}\cdot p_2 = $$
]
---
# References
