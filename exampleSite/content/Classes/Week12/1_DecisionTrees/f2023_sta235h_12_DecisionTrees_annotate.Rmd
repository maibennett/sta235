...
.small[
```{r rmse, fig.height=3.8, fig.width=8, fig.align='center', dev='svg', echo=TRUE, warning=FALSE}
plot(ct)
...
.small[
```{r full_tree, fig.height=4.5, fig.width=10, fig.align='center', dev='svg', echo=TRUE, warning=FALSE}
library(rattle)
...
```{r full_tree2, fig.height=4.5, fig.width=8, fig.align='center', dev='svg', echo=FALSE, warning=FALSE}
fancyRpartPlot(ct$finalModel, caption = "Classification tree for Unsubscribe")
```
...
.pull-left[
```{r plot_tree_reg, fig.height=5, fig.width=5, fig.align='center', dev='svg', echo=TRUE, warning=FALSE, results=FALSE}
...
---
.box-6Trans[Q4: What would the predicted value be for a customer who hasn't watched Succession and lives in a city?]

.pull-left[
```{r plot_tree_reg2, fig.height=4, fig.width=5, fig.align='center', dev='svg', echo=TRUE, warning=FALSE, results=FALSE}
fancyRpartPlot(rt$finalModel, caption="Regression Tree for Login")
```
]
...
- Go to **.darkorange[https://sta235h.click/Week12]** and read the exercise.
