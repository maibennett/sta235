...
.center2[
.box-6Trans[Q1: What is the main disadvantage of a shallower tree?]

.box-6trans[a) Higher variance]
.box-6trans[b) Higher bias]
.box-6trans[c) Lower variance]
.box-6trans[d) Lower bias]
]
...
.box-3[Remember our HboMax example?]
...
Using the code on **https://sta235.netlify.app/inclass/ex2**:

  - Fit a classification tree using **.darkorange[all the covariates]**
  
  - Show your optimal `cp` and your final classification tree.
  
  - What is the accuracy of your tree?
