...
$$E[Y|X_1,..., X_P] = Pr(Y = 1|X_1,...,X_p)\cdot 0 + Pr(Y = 1|X_1,...,X_p)\cdot 1$$
$$= Pr(Y = 1|X_1,...,X_p)$$
...
$$p = \frac{\exp(\beta_0 + \beta_1 X_1 + ... + \beta_p X_p)}{1+\exp(\beta_0 + \beta_1 X_1 + ... + \beta_p X_p)}$$
---
# How to interpret the coefficients? (cont.)
...
- **.darkorange[Differences are not constant for across values of X<sub>j</sub>]**
...
tab <- cbind(c("LPM for explanation","no","yes"),c("no","11","11"),c("yes","4","3"))
...
<br>
<br>
- LMP and Logistic Regression can **.darkorange[both be useful]** depending on the context.
