---
title: "STA 235H - Multiple Regression: Interactions & Other Issues"
subtitle: "Fall 2022"
...
- It can be **.darkorange[structural]** (e.g. include $X$ and $X^2$) or from the **.darkorange[data]**
...
- For an additional 1,000 miles, the price inscreases/decreases, on average, by $(e^{\hat{\beta}}-1)\cdot 100$%, holding other variables constant.
...
- Another objective of looking at our data is to see whether we have observations that look "strange".

```{r cars_outliers, fig.height=5, fig.width=7.5, fig.align='center', dev='svg', echo=FALSE, warning=FALSE}
...
- Which ones do you think could be outliers?

---
background-position: 50% 50%
class: center, middle
.big[
.box-7LA[Let's go to R]
