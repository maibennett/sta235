...
```
```{r sales_res, fig.height=4, fig.width=6.5, fig.align='center', dev='svg', echo=FALSE, warning=FALSE, message = FALSE}
sales_fitted <- augment(lm(Sales ~ p1 + p2, data = sales))
...
```{r beers_height_weight, fig.height=4, fig.width=4.5, fig.align='center', dev='svg', echo=FALSE, warning=FALSE, message = FALSE}
...
```{r corrplot, fig.height=3.8, fig.width=4.3, fig.align='center', dev='svg', echo=TRUE, warning=FALSE, message = FALSE}
M <-cor(beers)
