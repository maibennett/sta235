...
```{r sales_p1_p2, fig.height=4.5, fig.width=8.5, fig.align='center', dev='svg', echo=FALSE, warning=FALSE, message = FALSE}
...
---
# Some of your answers in the JITT Assingment
...
d2$variables = factor(d2$variables, levels = c("w+g","h+w+g","other"))

cols = c("#5601A4","#900DA4","#FCCE25")
