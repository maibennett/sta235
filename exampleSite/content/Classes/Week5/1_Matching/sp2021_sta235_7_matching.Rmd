...
- We can use the same formulas, but now $e_i$ is not the probability of being assigned to treatment, but the probability of **.darkorange[being in the population sample]**.
