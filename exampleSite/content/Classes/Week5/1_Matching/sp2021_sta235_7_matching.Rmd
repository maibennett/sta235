...
- Data that has not been manipulated for an experiment, e.g. data in its "natural state".
...
.pull-left[
.center[
.![](https://media.giphy.com/media/fu2rIw18eIDz1YCrCT/giphy.gif)
]
]

.pull-right[
- Now, we will move away from the core assumption of RCTs: that **.darkorange["the probability of treatment assignment is a known function"]** (Imbens & Rubin, 2015).

--

- We will maintain the assumption of **.darkorange[unconfoundnedness]**.
...
<br>
$$Y(z) \perp\!\!\!\perp Z|X \ \ \ \forall \ z \in \{Z\}$$
---
