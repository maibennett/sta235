...
.box-2LA[Homework 2 will be posted today (due March 8th)]

--

- Shorter assignment, but you **.darkorange[need to review the material and videos]**. 

--

- Get your questions in **.darkorange[early]** (OH or Piazza). **.darkorange[No answers during the weekend]**.
...
- Slides and videos for matching class will be posted **.darkorange[tomorrow]**.


---
# Some Updates (cont.)

.box-4LA[Midterm is now on 03/29]

--

- It will be **.darkorange[very similar to homework assignments]**. 

--

- You will need a **.darkorange[web cam or camera]**.

--

- Make sure you have a **.darkorange[stable internet connection]**.

--

- Absences to the midterm need to be **.darkorange[properly justified]** and your midterm grade will be **.darkorange[the grade on your final exam]**.
...
.box-6[For meetings, propose a number of dates and time slots]

--

.box-7[Follow instructions]

---

.center2[
.box-5LA[Let's review Homework 1]]