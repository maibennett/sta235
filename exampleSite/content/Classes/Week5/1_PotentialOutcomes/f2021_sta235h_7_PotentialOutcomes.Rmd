...
<br>
**.darkorange[TRUE OR FALSE]**: "For one additional mailing a year, the probability of donating increases by 0.06%"
...
<br>
**.darkorange[TRUE OR FALSE]**: "In this model, standard errors are larger than they would have been if we used lm() instead."
...
- Last week we discussed potential outcomes, (e.g. $Y_i(1)$ and $Y_i(0)$):
  .center["The outcome that *we would have observed* in the case of difference scenarios"]
