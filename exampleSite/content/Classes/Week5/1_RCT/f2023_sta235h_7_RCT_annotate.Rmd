...
- About **.darkorange[JITT feedback]**:
  ...
  - Currently ~90% ok with speed.
  - Additional support is available.
  
--

- **.darkorange[No OH next Wednesday (09/27)]** (changed to Tuesday0; check OH calendar).
...
.box-2trans[E.g.: Population mean; difference between groups]
...
.box-7trans[E.g.: Result of the sample mean<br>for a given sample *S*<br>Estimate for a simple regression]

.box-7trans[$$\hat{\mu} \ \ ; \ \ \hat{\beta}$$]
]
.center[
.box-4[Estimator]
...
.box-4trans[$$\frac{1}{n}\sum_i Y_i \ \ ; \ \ \frac{1}{n_1}\sum_{Z=1} Y_i - \frac{1}{n_0}\sum_{Z=0} Y_i$$]
]
...
---
# Definition: Identification Strategy
<br>
<br>
According to Keele (2015):

<br>
.center["A **.darkorange[research design]** intended to solve the identification problem"]

--

.center["Consists of an assumption or set of assumptions that will **.darkorange[identify the causal effect]** of interest"]
