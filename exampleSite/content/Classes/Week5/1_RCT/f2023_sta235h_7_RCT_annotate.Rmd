...
- For emails, remember to include **.darkorange[STA 235H]** on the subject line for a faster response.
...
ggplot(data = d) +
  geom_density(aes(x = income0, color = "Y(0)"), lwd = 1.1, lty=2) +
  geom_density(aes(x = income1, color = "Y(1)"), lwd = 1.1, lty=2) +
