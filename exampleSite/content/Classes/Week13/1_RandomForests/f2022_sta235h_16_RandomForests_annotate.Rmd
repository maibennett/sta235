...
- **.darkorange[Homework 6]** is due this Friday

- **.darkorange[Homework 7]** will be posted this Friday as well (shorter homework)

  - Remember that it is due **.darkorange[Thursday Dec. 1st]** and <u>you cannot submit late</u>.
...
- One **.darkorange[final JITT]**: No content, but you will need to make sure Proctorio works.

  - No video recording, no websites blocked. 
  - You will need to show an ID before starting. Only one device and one screen.
...
.center2[
.box-4Trans[Q1) In term of bias, which one is better: A deep tree or a shallow tree?]
]
...
.center2[
.box-7Trans[Q2) We are trying to predict Sales. How many different prediction values for sales will I have, at most, considering the previous decision tree?]
]
...
.center2[
.box-5Trans[Q3) What is the main objective of bagging?]
]
---
...
.center2[
.box-3Trans[Q4) In a Random Forest, a higher number of trees will yield an... underfitted model? overfitted model? doesn't affect?]
]
...
.center2[
.box-6Trans[Q5) A tree with just a root and two leaves is called a stomp. Are these high or low-bias trees?]
]
...
.center2[
.box-7Trans[Q6) What is the main objective of boosting?]
]
