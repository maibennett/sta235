...
.center2[
.box-6LA[Our dataset has 11 variables (1 outcome + 10 predictors)... why does the precitors go from 2 to 11?]
]
...
.center2[
.box-3LA[In a Random Forest, a higher number of trees will yield a[n]...]
]
...
.pull-right[
![:scale 100%](https://raw.githubusercontent.com/maibennett/sta235/main/exampleSite/content/Classes/Week13/1_RandomForests/images/boosting2.png)]
...
.center2[
.box-4LA[In boosting, a higher number of trees will yield a[n]...]
]
...
- There are other types of boosting, like **.darkkorange[adaptative boosting]** (you saw it in the video!)
