...
- **.darkorange[Homework 5]** will be posted on Thursday

--

- Grades for the Midterm and Homework 4 will be posted **.darkorange[this week]**
...
.center2[
.box-5LA[Now it's your turn]
]

---
# In-class exercise

- Go to **.darkorange[https://sta235.netlify.app/in-class/ex1.R]** and download the code

- You will have **.darkorange[10min]** for this task. Feel free to comment with your classmates here.

- When time is up, **.darkorange[you can submit your R script in Canvas]** (no need for a write-up)
