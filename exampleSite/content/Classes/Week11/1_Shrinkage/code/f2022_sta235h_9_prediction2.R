################################################################################
### Title: "Week 11 - Stepwise and Regularization"
### Course: STA 235H
### Semester: Fall 2022
...
#You might need to install the package "leaps"
...
# Exercise: Do the same CV procedure, but with backwards stepwise. Which model do you choose in that case? (method = "leapBackward")
...
# See the numbers we will be testing by running head(lambda_seq), and compare it to a vector
# lambda_seq <- seq(0,10,length = 100). What's the main difference you see?
...
ols <- train(logins ~ . - unsubscribe, data = train.data,
...
# Question: What happens if we use the formula unsubscribe ~ . - id ?
