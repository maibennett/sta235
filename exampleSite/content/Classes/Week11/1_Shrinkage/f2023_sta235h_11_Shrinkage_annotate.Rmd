...
.center[*A simpler model is higher bias compared to a more complex one.*]
...
.center[*We need to split our data to reserve a portion that is "unseen" by our model, and properly test its accuracy.*]
...
.center[*We train them on the training dataset and then we calculate the RMSE on the testing dataset.*]
