...
.center[![:scale 60%](https://github.com/maibennett/sta235/raw/main/exampleSite/content/Classes/Week3/1_PotentialOutcomes/images/headache.png)]
...
.center[![:scale 60%](https://github.com/maibennett/sta235/raw/main/exampleSite/content/Classes/Week3/1_PotentialOutcomes/images/headache_pill.png)]
...
---
# Headache is gone!
.center[![:scale 60%](https://github.com/maibennett/sta235/raw/main/exampleSite/content/Classes/Week3/1_PotentialOutcomes/images/headache_pill_happy.png)]
...
.box-3tL[Did the aspirin work?]
<br>
.box-5tL[We can't know!]
]
---
# A world of potential (outcomes)

- Two parallel worlds
- Headache - pill - No headache
- Headache - no pill - headache

---
# A world of potential (outcomes)

- A priori, the first scenario would be the potential outcome if I take the pill.

- The second scenario would be the potential outcome if I don't take the pill.
...
- Let $T$ be the treatment or intervention (e.g. taking a pill).

Then,

$$Y_i | T = 1 \overset{\Delta}{=} Y_i(1) $$
where $Y_i(1)$ is the **.darkorange[potential outcome under treatment]**.

In the same fashion,

$$Y_i | T = 0 \overset{\Delta}{=} Y_i(0) $$
where $Y_i(1)$ is the **.darkorange[potential outcome under control]**.

$$\rightarrow Y_i = T\cdot Y_i(1) + (1-T)\cdot Y_i(0)$$
...
.box-6LA[Can we ever observe individual causal effects?]
