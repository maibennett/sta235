---
title: "STA 235H - Multiple Regression: Binary Outcomes"
subtitle: "Fall 2023"
...
$$Pr(Y|X_1,...,X_p) = \frac{1}{1+e^{-(\beta_0 + \beta_1X_1+...+\beta_pX_p)}}$$
...
```{r logit1, fig.height=5.5, fig.width=7.5, fig.align='center', dev='svg', echo=FALSE, warning=FALSE, message = FALSE}
