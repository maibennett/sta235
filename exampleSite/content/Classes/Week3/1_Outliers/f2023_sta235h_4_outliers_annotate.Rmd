---
title: "STA 235H - Multiple Regression: Outliers"
subtitle: "Fall 2023"
...
```{r hist_hmda, fig.height=5, fig.width=8, fig.align='center', dev='svg', echo=FALSE, warning=FALSE}
library(tidyverse)
library(hrbrthemes)
library(firasans)
...
hmda <- hmda %>% filter(action_taken==1 & loan_purpose==1)

ggplot(data = hmda, aes(x = loan_amount_000s)) +
  geom_histogram(color = "darkorange", fill = alpha("darkorange",0.5), linewidth = 1.1) +
  xlab("Loan amount (1,000 US$)") + ylab("Count") + 
...
```{r loan_income, fig.height=5.5, fig.width=8, fig.align='center', dev='svg', echo=FALSE, warning=FALSE}

ggplot(data = hmda, aes(y = loan_amount_000s, x = applicant_income_000s)) +
  geom_point(pch = 21, color = "darkorange", fill = alpha("darkorange",0.5), size = 3) +
  ylab("Loan amount (1,000 US$)") + xlab("Applicant income (1,000 US$)") + 
   theme_ipsum_fsc(plot_title_face = "bold",plot_title_size = 24) + #plain 
  theme(plot.margin=unit(c(1,1,1.5,1.2),"cm"),
        panel.grid.major.x = element_blank(),
        panel.grid.minor.x = element_blank(),
...
```{r loan_income2, fig.height=5.5, fig.width=8, fig.align='center', dev='svg', echo=FALSE, warning=FALSE}
hmda_outliers = hmda %>% filter(loan_amount_000s>750 | applicant_income_000s>600)

ggplot(data = hmda, aes(y = loan_amount_000s, x = applicant_income_000s)) +
  geom_point(pch = 21, color = "darkorange", fill = alpha("darkorange",0.5), size = 3) +
  geom_point(data = hmda_outliers, aes(y = loan_amount_000s, x = applicant_income_000s), 
             pch = 21, color = "#900DA4", fill = alpha("#900DA4",0.5), size = 3) +
  ylab("Loan amount (1,000 US$)") + xlab("Applicant income (1,000 US$)") + 
   theme_ipsum_fsc(plot_title_face = "bold",plot_title_size = 24) + #plain 
  theme(plot.margin=unit(c(1,1,1.5,1.2),"cm"),
        panel.grid.major.x = element_blank(),
...
```{r loan_income3, fig.height=5.5, fig.width=8, fig.align='center', dev='svg', echo=FALSE, warning=FALSE}
ggplot(data = hmda, aes(y = loan_amount_000s, x = applicant_income_000s)) +
  geom_point(pch = 21, color = "darkorange", fill = alpha("darkorange",0.5), size = 3) +
  geom_smooth(aes(color = "Linear fit"), method = "lm", se = FALSE, lwd = 1) +
  geom_point(data = hmda_outliers, aes(y = loan_amount_000s, x = applicant_income_000s), 
             pch = 21, color = "#900DA4", fill = alpha("#900DA4",0.5), size = 3) +
  scale_color_manual(values = c("darkorange"), name = "Regression lines") +
  ylab("Loan amount (1,000 US$)") + xlab("Applicant income (1,000 US$)") + 
   theme_ipsum_fsc(plot_title_face = "bold",plot_title_size = 24) + #plain 
  theme(plot.margin=unit(c(1,1,1.5,1.2),"cm"),
        panel.grid.major.x = element_blank(),
  ...
  theme(axis.title.x = element_text(size=18),#margin = margin(t = 10, r = 0, b = 0, l = 0)),
        axis.text.x = element_text(size=14),
        axis.title.y = element_text(size=18),#margin = margin(t = 0, r = 10, b = 0, l = 0)),
        axis.text.y = element_text(size=14),legend.position=c(0.8,0.2),
        legend.title = element_blank(),
        legend.text = element_text(size=15),
        legend.background = element_rect(fill="white",colour ="white"),
        title = element_text(size=14))
...
```{r loan_income4, fig.height=5.5, fig.width=8, fig.align='center', dev='svg', echo=FALSE, warning=FALSE}
hmda_without_outliers = hmda %>% filter(loan_amount_000s<=750 & applicant_income_000s<=600)
...
ggplot(data = hmda, aes(y = loan_amount_000s, x = applicant_income_000s)) +
  ...
  geom_point(data = hmda_outliers, aes(y = loan_amount_000s, x = applicant_income_000s), 
             pch = 21, color = "#900DA4", fill = alpha("#900DA4",0.5), size = 3) +
  geom_smooth(data = hmda_without_outliers, aes(y = loan_amount_000s, x = applicant_income_000s, color = "Linear fit w/o outliers"),
              method = "lm", se = FALSE, lwd = 1) +
  scale_color_manual(values = c("darkorange", "#900DA4"), name = "Regression lines") +
  ylab("Loan amount (1,000 US$)") + xlab("Applicant income (1,000 US$)") + 
   theme_ipsum_fsc(plot_title_face = "bold",plot_title_size = 24) + #plain 
  theme(plot.margin=unit(c(1,1,1.5,1.2),"cm"),
        panel.grid.major.x = element_blank(),
...
.box-3LA[Let's do some exercises!]
