...
.pull-left[
```{r jitt, fig.height=5, fig.width=5, fig.align='center', dev='svg', echo=FALSE, warning=FALSE, message = FALSE}
library(ggplot2)
library(gridExtra)
library(hrbrthemes)
library(firasans)
...
.pull-right[
```{r jitt2, fig.height=5, fig.width=5, fig.align='center', dev='svg', echo=FALSE, warning=FALSE, message = FALSE}
