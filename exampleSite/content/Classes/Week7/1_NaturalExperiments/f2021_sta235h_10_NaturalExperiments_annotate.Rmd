...
---
# Perfect time to talk about natural experiments

.center[
![:scale 100%](https://raw.githubusercontent.com/maibennett/sta235/main/exampleSite/content/Classes/Week7/1_NaturalExperiments/images/nyt_nobel.png)]
...
- Grades for **.darkorange[homework 2 were posted]**:
  
  - Check the point assignment in the comments.
  
  - Any questions about your grade, send it to me.
...
- **.darkorange[Difference-in-Differences]**:
...
- People selected through a **.darkorange[lottery]**.
  ...
  - If a person was selected, their whole household was selected, too.]

.pull-right[
.center[
![](https://raw.githubusercontent.com/maibennett/sta235/main/exampleSite/content/Classes/Week7/1_NaturalExperiments/images/map1_edited.jpg)
]
]
...
- We can find **.darkorange[natural experiments]** in many places!

--

- But it's important to **.darkorange[credibly]** convince people they are not correlated with potential outcomes!

  - No confounding or CIA.

--

- What happens if we have two cities that have an equal probability to be hit by an hurracaine, and you want to analyze the effect of a natural disaster on employment.

  - City A: Large metropolitan city
  
  - City B: Smaller, urban city
  
  .box-5[Can you use this setting?]
