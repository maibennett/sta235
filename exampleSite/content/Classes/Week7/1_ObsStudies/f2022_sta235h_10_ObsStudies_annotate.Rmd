...
.pull-left[
- Continue talking about **.darkorange[Observational Studies]**

- Can we use **.darkorange[matching]** for causal effects?

- Introduce **.darkorange[difference-in-differences]**
]

.pull-right[
![](https://media.giphy.com/media/jUzczP42fMgE8NxSZ0/giphy.gif)
]