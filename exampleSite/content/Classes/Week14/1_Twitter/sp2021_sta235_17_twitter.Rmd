...
---
.center[
![:scale 100%](https://raw.githubusercontent.com/maibennett/sta235/main/exampleSite/content/Classes/Week14/1_Twitter/images/ss1.png)
]
...
---
.center[
![:scale 100%](https://raw.githubusercontent.com/maibennett/sta235/main/exampleSite/content/Classes/Week14/1_Twitter/images/ss2.png)
]

---
.center[
![:scale 100%](https://raw.githubusercontent.com/maibennett/sta235/main/exampleSite/content/Classes/Week14/1_Twitter/images/ss3.png)
]
...
word_tb <- output_list %>% # This is the list of data we got from Amazon
              ...
              filter(!(word %in% c("banana","bananas","slicer"))) %>% #we want to exclude bananas and slicer because we already know what it is
...
```{r wordcloud_amazon, fig.height=4.5, fig.width=10, fig.align='center', dev='svg', echo=TRUE, warning=FALSE, results=FALSE}
...
---
.center[# Now let's look at Twitter]

.center[
![:scale 100%](https://raw.githubusercontent.com/maibennett/sta235/main/exampleSite/content/Classes/Week14/1_Twitter/images/twitter.eps)
]
...
---
```{r, echo=FALSE}
countdown(minutes = 10, seconds = 0, update_every = 60, play_sound = TRUE, box_shadow = TRUE, right = "33%", bottom = "90%",
          color_border = "#5601A4",
          color_text = "#5601A4",
...
.center[
![:scale 100%](https://raw.githubusercontent.com/maibennett/sta235/main/exampleSite/content/Classes/Week14/1_Twitter/images/cis.png)
]
---
# References
