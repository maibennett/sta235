...
.center[
![:scale 100%](https://raw.githubusercontent.com/maibennett/sta235/main/exampleSite/content/Classes/Week14/1_Twitter/images/twitter.png)
]
...
- To complete the survey either point with your phone to the QR code or

- Go to **.darkorange[https://bit.ly/longhorn-cis]**
...
```{r, echo=FALSE}
library(countdown)
countdown(minutes = 10, seconds = 0, update_every = 60, play_sound = TRUE, box_shadow = TRUE, right = "80%", bottom = "20%",
          color_border = "#5601A4",
          color_text = "#5601A4",
...
.pull-right[
.center[
![:scale 100%](https://raw.githubusercontent.com/maibennett/sta235/main/exampleSite/content/Classes/Week14/1_Twitter/images/qr_cis.jpg)]
]
