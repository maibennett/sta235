...
.center[
.box-4LA[Homework 6 due on Thursday]
]

<br>
--

- **.darkorange[Grades for Homework 5]** have been posted: Check the returned submissions!

  - Bi-modal distribution of grades
  - Work as a group!

--

- **.darkorange[Final Exam]** is cumulative: Due on <u>Wednesday Dec 8th</u>

  - It should take you <u>3 hrs</u> at most to complete.
  - It will be posted Monday Dec 6th (8:00am)
  - No extensions
...
.center2[
.box-5LA[Re-grading only until Friday Dec 3rd]
]
...
.pull-right[
.center[
![](https://raw.githubusercontent.com/maibennett/sta235/main/exampleSite/content/Classes/Week14/1_RandomForests/images/tree_example.png)]
]
...
- We will actually grow **.darkorange[full trees]** and then **.darkorange[prune]** them.
...
![:scale 80%](https://raw.githubusercontent.com/maibennett/sta235/main/exampleSite/content/Classes/Week14/1_RandomForests/images/bootstrap1.png)
...
![:scale 80%](https://raw.githubusercontent.com/maibennett/sta235/main/exampleSite/content/Classes/Week14/1_RandomForests/images/bootstrap2.png)
---
# Introduction to Bagging
...
![:scale 80%](https://raw.githubusercontent.com/maibennett/sta235/main/exampleSite/content/Classes/Week14/1_RandomForests/images/bootstrap3.png)
---
# Introduction to Bagging
...
![:scale 80%](https://raw.githubusercontent.com/maibennett/sta235/main/exampleSite/content/Classes/Week14/1_RandomForests/images/bootstrap4.png)
---
# Introduction to Bagging
...
![:scale 80%](https://raw.githubusercontent.com/maibennett/sta235/main/exampleSite/content/Classes/Week14/1_RandomForests/images/bootstrap5.png)
...
.pull-right[
![:scale 100%](https://raw.githubusercontent.com/maibennett/sta235/main/exampleSite/content/Classes/Week14/1_RandomForests/images/bagging.jpg)
]
...
.center2[
.box-3LA[In a Random Forest, a higher number of trees will yield an... underfitted model? overfitted model? doesn't affect?]
]
...
.center[
![:scale 80%](https://raw.githubusercontent.com/maibennett/sta235/main/exampleSite/content/Classes/Week14/1_RandomForests/images/boosting2.png)]
...
.center2[
.box-4LA[In boosting, a higher number of trees will yield an... underfitted model? overfitted model? does't affect?]
]
...
Using the code on **https://sta235.netlify.app/inclass/ex3.R**:

  - Fit a random forest using **.darkorange[all the covariates]**
  
  - Complete the code and show your optimal number of covariates.
  
  - What is the most important covariate?
  
  - What is the accuracy of your RF?
...
<br>
<br>
.center[.box-4LA[Happy Final Class!]]

--
<br>

.center[.box-4Trans[Thank you for all your participation]]
