...
- Remember that <u>all</u> submissions for JITTs are **.darkorange[formal submissions]** for an assignment.

  - Use proper language (e.g. "nah" or "meh" are not actual words) and keep answers pertinent to the class.
...
- **.darkorange[Natural Experiments]**
  ...
  - Importance of the context and checking balance.
...
- **.darkorange[Difference-in-Differences (DD)]**:
  ...
  - *Make sure to check the JITT answer on the course website*.
]
...
rdplot(y = sales$sales, x = sales$dist, c = 0, 
       title = "RD plot", x.label = "c - time", y.label = "sales")
```
...
rdplot(y = sales$sales, x = sales$dist, c = 0, title = "RD plot",
       x.label = "c - time", y.label = "sales", col.dots = "#F89441", col.lines = "#900DA4")
```
...
.center[You can check the answers at **sta235h.clicks/Week8Answers**]
