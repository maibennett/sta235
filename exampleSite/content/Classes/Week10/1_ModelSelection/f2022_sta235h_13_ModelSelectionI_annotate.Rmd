...
```{r, echo=TRUE}
hbo <- read.csv("https://raw.githubusercontent.com/maibennett/sta235/main/exampleSite/content/Classes/Week9/1_ModelSelection/data/hbomax.csv")
...
- **.darkorange[Simple Model]**:
  ...
  $$logins = \beta_0 + \beta_1\times GoT + \beta_2 \times city + \varepsilon_i$$
