...
- Re-grading for homework 3 available **.darkorange[until this Thursday]**.

  - Please <u>check the rubric</u> and based on that ask for a specific re-grade.
  
--

- Think of **.darkorange[assignment drop]** as an insurance policy.

  - Start assignments with enough time *if you already think you used your drop*.

--

- **.darkorange[Grades for the midterm]** will be posted on Tuesday.
...
- **.darkorange[Start of a completely new chapter]**
...
.pull-left[
.center[
![](https://media.giphy.com/media/k9HCTV5kwOa9pWVISy/giphy.gif)
]
]
...
- During the following weeks, we will be playing **.darkorange[trivia]**.

--

- Make a team of **.darkorange[max. 3 people]** and fill out a sheet with your names (<u>one per team</u>).

--

- During the class, there will be some questions (Q1, Q2, ...) that you have to answer with your team. **.darkorange[Discuss the answer and write it down before the time is up!]**

  - Same as bar trivia, this is an <u>honor system</u> thing.
  
--

- At the end of the class, **.darkorange[submit your sheet]**.
...
--
- **.darkorange[Root Mean Squared Error (RMSE)]**: *Measured in the same units as the outcome!*
$$RMSE = \sqrt{MSE}$$
...
- Go to **.darkorange[https://sta235h.click/Week10]** and read the exercise.
...
.center[*Answers will be posted on Wednesday afternoon!*]
...
- We now have methods to **.darkorange[select models]**.
]
...
- **.darkorange[Shrinkage/Regularization methods]**: 
