...
succession <- sample(c(0,1),n,replace=TRUE, prob=c(0.3,0.7))
...
xb_l <- 2.5 - 5*succession + city*2 + rnorm(n, 0, 1)
...
xb <- 0.15 - 0.01*city + succession*0.2 + (logins==0)*0.1 + rnorm(n, 0, 0.05)
...
$$
\begin{aligned}
logins =& \beta_0 + \beta_1\times Succession + \beta_2\times age + \beta_3\times age^2 +\\
