...
xb_l <- 2 - 5*mandalorian - age^2*0.05 - female + city*2 + rnorm(n, 0, 2)

logins <- ifelse(xb_l < -135,0,ifelse(xb_l< -130, 1, ifelse(xb_l < -120, 2,
                                                            ifelse(xb_l < -110, 3, ifelse(xb_l < -105, 4,
                                                                                          ifelse(xb_l < -100, 5, ifelse(xb_l < -90,
                                                                                                                        6, ifelse(xb_l < -80, 7, ifelse(xb_l < -70, 8, ifelse(xb_l < -65, 9, 10))))))))))
