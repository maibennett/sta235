...
xb <- 0.15 - 0.0001*age + mandalorian*0.2 + (logins==0)*0.1 + rnorm(n, 0, 0.05)
...
- **.darkorange[Simple Model]**:
  ...
  $$unsubscribe_i = \beta_0 + \beta_1\times mandalorian + \beta_2 \times \mathrm{I}(logins=0) + \varepsilon_i$$
  
- **.darkorange[Complex Model]**:

$$
\begin{aligned}
unsubscribe_i =& \beta_0 + \beta_1\times mandalorian + \mathbf{\beta_2} \times logins + \beta_3\times age +\\
&\beta_4\times age^2 + \beta_5\times city + \beta_6\times female + \varepsilon_i
\end{aligned}
$$
