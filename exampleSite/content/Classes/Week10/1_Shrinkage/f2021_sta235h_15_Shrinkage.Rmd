...
--
- Please check out the **.darkorange[notes for submissions]** on HW4.

- Check out answers on **.darkorange[Canvas discussion board]**!

- I'll **.darkorange[complement]** what we see in class with R code videos when needed.
...
- **.darkorange[Teams of three or four]**, depending on your section (you should enter your team on Canvas if you haven't done so).
...
data <- read.csv("https://raw.githubusercontent.com/maibennett/sta235/main/exampleSite/content/Classes/Week10/1_Shrinkage/data/purchases.csv")
...
---
.center[
![:scale 90%](https://raw.githubusercontent.com/maibennett/sta235/main/exampleSite/content/Classes/Week10/1_Shrinkage/images/ridge.png)]
