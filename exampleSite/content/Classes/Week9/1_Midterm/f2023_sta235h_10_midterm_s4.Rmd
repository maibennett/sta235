...
- You will have **.darkorange[1hr 40min]** for the midterm, or until **.darkorange[5.50pm]**, whichever comes first.

- There will be **.darkorange[no questions during the midterm]**. 
  
  - If needed, assume what you think is necessary, using your best judgement and how we've usually done things in class.
  
- This is a **.darkorange[proctored exam]**, so please abide by this.
  
  - <u>Do not access any online resources</u>, or it will be considered cheating.
  - <u>Do not stop sharing your screen</u> $\rightarrow$ if screen-sharing is stopped, your midterm will only be graded up to that point.
  
- **.darkorange[Do not copy any of the questions from the exam]**.

  
- **.darkorange[Do not share the content of the exam]** with other students.
