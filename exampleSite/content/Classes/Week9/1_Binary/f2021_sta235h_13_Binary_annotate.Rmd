...
.pull-left[
- Discussed **.darkorange[Regression Discontinuity Designs]**:

  - Strong internal validity vs. limited external validity
  - Assumptions behind RD designs
  - Robustness checks
  
- Finished with **.darkorange[causal inference]** chapter.
]
...
- Start our **.darkorange[prediction chapter]**:
...
.pull-left[
- We have been using **.darkorange[binary outcomes]** in regressions, but haven't fully discussed the issues they might bring.
...
- $(\exp(1.27)-1)\cdot 100\% = 257\%$ more likely to be denied a mortgage if you are African American vs not African American, holding payments to income ratio constant.
