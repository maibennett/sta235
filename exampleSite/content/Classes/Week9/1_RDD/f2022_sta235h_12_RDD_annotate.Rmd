...
.center2[
.box-2LA[For what population within my sample am I comparing?]
...
.box-2trans[(e.g. other policy also changes right at that cutoff, people with certain characteristics can manipulate their running variable)]
...
- The simplest way to do this is to fit a regression using **.darkorange[interactions of the treatment variable and the running variable]**:
