...
mlda = read.csv("https://raw.githubusercontent.com/maibennett/sta235/main/exampleSite/content/Classes/Week8/1_RDD/data/mlda.csv")
```
...
According to the linear model, the estimate is 122.9, while for rdrobust is -67.47. Why is there such a big difference?
...
As you can see, the linear plot doesn't do a good job approximating the data for the treatment group, so it seems like there is a "positive" effect of MLDA (increase in arrests), but there's actually not.