...
- `female`: Total number of female arrests (sim)

## Tasks

1) Let's start creating the variables we will need! Create a running variable `r` centered around the 21st birthday (*Hint: You will need to use age and subtract the cuoff*), and a treatment variable `treat` that takes the value of (1) if the person can legaly drink and 0 in another case.
