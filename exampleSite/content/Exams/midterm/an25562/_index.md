...
{{% notice info %}}
This exam was created exclusively for Alexandra Nishida (EID: an25562), and every exam is different. You will be graded based on this version of the exam.
{{% /notice %}}
...
<a onclick="ga('send', 'event', 'External-Link','click','an25562_midterm','0','Link');" href="https://sta235.netlify.app/exams/midterm/an25562/an25562_midterm.html" target="_blank" class="btn btn-default"> Accept <i class="fas fa-check-square"></i></a> 