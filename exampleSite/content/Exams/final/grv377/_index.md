...
{{% notice info %}}
This exam was created exclusively for Riya Vasal (EID: grv377), and every exam is different. You will be graded based on this version of the exam.
{{% /notice %}}
...
<a onclick="ga('send', 'event', 'External-Link','click','grv377_final','0','Link');" href="https://sta235.netlify.app/exams/final/grv377/grv377_final.html" target="_blank" class="btn btn-default"> Accept <i class="fas fa-check-square"></i></a> 