...
```{r, echo = TRUE, warning = FALSE, message = FALSE, eval = FALSE}
sumtable(cereal, out = "csv", file = "C:/Users/mc72574/Desktop/sumtable_cereal.csv", digits = 2,
         title = "Summary statistics for Cereal Data")

sumtable(cereal, out = "html", file = "C:/Users/mc72574/Desktop/sumtable_cereal.html", digits = 2,
         title = "Summary statistics for Cereal Data")
```
...
```{r, echo = TRUE, warning = FALSE, message = FALSE, results = "asis"}
stargazer(cereal, title = "Summary statistics for Cereal Data")
```
...
```{r, echo = TRUE, warning = FALSE, message = FALSE, eval = FALSE}
stargazer(lm0, lm1, lm2,
          title="Regressions results for Cereal Ratings", out = "C:/Users/mc72574/Desktop/reg_cereals.html")
```

If you want to keep the format of the table, one way is to export html into a .doc file, but you have to make small modifications to the p-value legends:

```{r, echo = TRUE, warning = FALSE, message = FALSE, eval = FALSE}
stargazer(lm0, lm1, lm2,
          title="Regressions results for Cereal Ratings", type = "html", out = "C:/Users/mc72574/Desktop/reg_cereals.doc")
```
