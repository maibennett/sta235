...
ggplot(data = ., aes(y = rating, x = sugars, color = factor(over100ca))) +
  geom_point() +
  xlab("Sugars") + ylab("Ratings") + 
  # scale_X_manual() allows you to include specific colors, legend titles, and labels!
  scale_color_manual("Over 100 calories?", values = c("skyblue","purple"), label = c("No","Yes")) +
  ggtitle("Rating vs Sugars") + 
    theme_minimal()
```
