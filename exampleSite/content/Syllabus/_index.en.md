...
-	James, G., D. Witten, T. Hastie, & R. Tibshirani. (2017) “An Introduction to Statistical Learning with Applications in R”. Springer. (Available online [here](https://static1.squarespace.com/static/5ff2adbe3fe4fe33db902812/t/6009dd9fa7bc363aa822d2c7/1611259312432/ISLR+Seventh+Printing.pdf)) 

All lecture slides, supplemental readings, course videos, and additional material will be provided via Canvas.


### ATTENDANCE EXPECTATIONS
I expect all students will attend virtually each class by logging on time via Canvas. Attending class is the easiest way to learn the different topics that will be covered in class and ask questions. However, given the current global pandemic we are living through, attendance will not count towards your final grade. Students will be required to complete Just in Time Teaching assignments (JITT) before some of the classes, and these will be considered in your final grade (see “Grading and Assignments” below). 

### BEHAVIOR EXPECTATIONS
You should think about this online class the same way you would think about an in-person class. The same rules of courteousness and professionalism apply here! To the best of your abilities, try to avoid outside distractions and keep your focus on the lecture. However, if you have other responsibilities that do not allow you to fully concentrate on the lecture (e.g. childcare), please reach out to the teaching team and we will work out a plan to help you succeed.
Depending on the size of the class, questions can be asked by unmuting yourself or through the online chat. I ask to keep the comments and questions in the chat relevant to the lecture, both in public and private chats.
...
There will be one online midterm and one final exam in this course (via Zoom). Additionally, there will be three homework assignments during the semester, a prediction data project, and Just in Time Teaching assignments (JITT) that should be completed before each class:
1.	Homework assignments: 20%
2.	Prediction Project: 15%
...
-	There will be three homework assignments in this course, with the following submission deadlines:
	...
	- **HW2: March 8th, 12:00 PM (noon)** (*Note: Date was changed to accomodate suspended classes due to winter storm.*)
...
-	You will be penalized with 10 points for each day your assignment is late. This penalty is to give everyone the same amount of time to submit their work. If you know you will not be able to submit the homework on time, please reach out to the teaching team as soon as possible (ideally, before the deadline). 

2.	**Prediction Data Project (15%)**
-	A longer homework assignment for students to use, test, and compare different prediction models with real world data.
-	Submission rules are the same as the ones stated for homework assignments.
 
3.	**Just in Time Teaching Assignments (10%)**
...
-	These assignments will not be graded for their content, but just for their completion. That being said, your submission should reflect that you tried to answer the questions appropriately. 
-	JITT assignments need to be completed the day before the class (i.e. if your class is on Monday, you should submit your answers before 11:59pm on Sunday).
